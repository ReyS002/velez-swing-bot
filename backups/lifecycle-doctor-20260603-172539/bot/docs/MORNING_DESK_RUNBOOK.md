...
Breakeven stop movement cancels the existing broker stop for the symbol and submits a replacement paper stop at entry for the current position quantity. Review Alpaca after any stop move.
