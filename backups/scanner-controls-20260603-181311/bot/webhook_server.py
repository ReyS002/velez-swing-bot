...
class TradingViewWebhookEngine:
    ...
    def scanner_public_status(self) -> dict:
        ...
        status["config"] = {
            ...
            "auto_submit": bool(self.scanner_config.get("auto_submit", True)),
            ...
            for bar in new_bars:
                ...
                for signal in signals:
                    ...
                    decision = self._build_order_decision(
                        signal,
                        alert_id,
                        dry_run=not bool(self.scanner_config.get("auto_submit", True)),
                    )
                    self._remember_decisions([decision], alert_id)
    ...
    def _scanner_exposure_snapshot(self) -> dict:
        ...
        if not self.broker.is_configured() or not bool(self.scanner_config.get("auto_submit", True)):
            return {
                "active_exposure": 0,
