...
The VPS runs Winston with a hybrid Groq/Ollama brain and a private PocketTTS voice service. The current live profile is:

```text
WINSTON_LLM_PROVIDER=openai_compatible
WINSTON_LLM_BASE_URL=https://api.groq.com/openai/v1
WINSTON_LLM_MODEL=openai/gpt-oss-20b
WINSTON_LLM_API_KEY=stored-in-.env
WINSTON_LLM_TIMEOUT_SECONDS=20
WINSTON_LLM_MAX_TOKENS=120
WINSTON_LLM_THINKING=
WINSTON_LLM_EXTRA_BODY_JSON={"reasoning_format":"hidden"}
WINSTON_LLM_FALLBACK_PROVIDER=ollama
WINSTON_LLM_FALLBACK_BASE_URL=http://ollama:11434
WINSTON_LLM_FALLBACK_MODEL=qwen3:4b
WINSTON_LLM_FALLBACK_THINK=false
WINSTON_RESEARCH_LLM_PROVIDER=openai_compatible
WINSTON_RESEARCH_LLM_BASE_URL=https://api.groq.com/openai/v1
WINSTON_RESEARCH_LLM_MODEL=qwen/qwen3.6-27b
WINSTON_RESEARCH_LLM_API_KEY=stored-in-.env
WINSTON_RESEARCH_THINKING=
WINSTON_RESEARCH_REASONING_EFFORT=
WINSTON_RESEARCH_LLM_EXTRA_BODY_JSON={"reasoning_format":"hidden"}
...
WINSTON_RESEARCH_FALLBACK_MODEL=qwen3:8b
WINSTON_RESEARCH_FALLBACK_THINK=false
WINSTON_DEEP_RESEARCH_LLM_PROVIDER=openai_compatible
WINSTON_DEEP_RESEARCH_LLM_BASE_URL=https://api.groq.com/openai/v1
WINSTON_DEEP_RESEARCH_LLM_MODEL=qwen/qwen3.6-27b
WINSTON_DEEP_RESEARCH_LLM_API_KEY=stored-in-.env
WINSTON_DEEP_RESEARCH_THINKING=
WINSTON_DEEP_RESEARCH_LLM_EXTRA_BODY_JSON={"reasoning_format":"hidden"}
