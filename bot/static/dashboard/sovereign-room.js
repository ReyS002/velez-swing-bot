import {mountRoomEnhancements} from "./sovereign-enhancements.js?v=1.6.5";
import {statueOutline} from "./sovereign-statue.js?v=1.4.3";
import {mountObjectMotion} from "./sovereign-motion.js?v=1.6.5";
// Shared Sovereign room shell. Keep byte-identical across bot editions.
export const SOVEREIGN_VERSION = "1.6.5";
...
export const ROOMS = {
  ...
  manhattan: { name:"New York", modes:{night:"Night",day:"Day"}, defaultTheme:"night", images:{night:"manhattan-night-clean.png",day:"manhattan-day-clean.png"},screen:[34.35,41.65,27.4,19.85],broadcast:[4.05,22.1,12.85,24.8],objects:{phone:[13.8,63,10.9,17],music:[27.8,66.3,4.4,11],journal:[69.6,73.6,8.9,9.4],keyboard:[33.3,72.5,24,6.3],trackpad:[58.7,73.3,6.5,4.8],lamp:[7.5,47,15.4,23.5],mission:[70.2,54.35,6.7,11.8],notes:[80.7,55.8,9.2,13.8],vault:[19.3780,35.8130,4.8445,6.2699],safe:[79.7,91.5,10.5,3.7],bookshelf:[19.2,23,5.5,2.5]} },
...
const ROOM_ART = {
 ...
 manhattan:[[316,332,110,84,316,146],[1040,486,511,212]],
...
export function roomHotspots() {
 ...
 return Object.entries(ROOMS[roomId].objects).map(([id,rect])=>{
