import {mountRoomEnhancements} from "./sovereign-enhancements.js?v=1.14.0";
import {statueOutline} from "./sovereign-statue.js?v=1.13.0";
import {mountObjectMotion} from "./sovereign-motion.js?v=1.14.0";
import {layoutStone,stoneFile} from "./sovereign-stone.js?v=1.14.0";
...
export const ROOMS = {
  cape: {name:"Cape Canaveral",modes:{day:"Coastal Day",night:"Launch Twilight"},defaultTheme:"night",images:{day:"cape-day-clean.png",night:"cape-night-clean.png"},screen:[38.1,40.6,19.85,17.5],broadcast:[4.95,17.45,11.35,19.75],objects:{phone:[17.4, 60.4, 13.2, 17.6],music:[32.2, 62.4, 3.1, 8.6],journal:[66.45,68.05,8.65,7.5],keyboard:[37.2,66.65,18,4.65],trackpad:[56.4,67,5.3,4.2],lamp:[8.4,44.3,14.9,23.4],mission:[63.2,53.2,7.3,10.5],notes:[74.6,56.6,10.5,10.8],vault:[19.5,9.65,3.9,6.6],bookshelf:[21.7,18.4,2.8,7.6]}},
  media: { name: "Executive", modes: { night: "Cinema", day: "Focus" }, defaultTheme: "night", images: { night: "executive-cinema-clean.png", day: "executive-focus-clean.png" }, screen: [37.25,45.55,25.1,18.1], broadcast: [31.699,15.409,36.603,27.843], objects: { phone:[18.8, 67, 13.2, 17.6],music:[32.7, 67.2, 3.1, 8.6],journal:[68.8,76.4,10.8,8.7],keyboard:[38.5,74.6,19.2,6],trackpad:[58.6,75.6,5.9,4.8],lamp:[12,48,15,25],mission:[69.65,59.3,6.45,10.6],notes:[78.5,61,12,14],vault:[85.9,48.9,3.05,7.3],bookshelf:[8,16,3.3,9] } },
  pacific: { name: "Hawaii", modes: { night: "Sunset", day: "Day" }, defaultTheme: "night", images: { night: "hawaii-sunset-clean.png", day: "hawaii-day-clean.png" }, screen: [33.7,40.65,27.2,20.65], broadcast: [4.8,21.6,11.6,25.5], objects: {phone:[13.2, 69, 13.2, 17.6],music:[28, 68, 3.1, 8.6],journal:[69.5,77,10.1,10.1],keyboard:[32.5,71.5,25,6.5],trackpad:[58.4,72.9,5.9,4.9],lamp:[7,47,16.5,24.5],mission:[70.7,55.9,7,11.5],notes:[81.5,55,11.5,17],vault:[19.1388,10.2019,4.3660,5.8448],bookshelf:[22,20,2.5,7]} },
  tokyo: { name: "Tokyo", modes: { day: "Clear Day", night: "Blue Hour" }, defaultTheme: "day", images: { day: "tokyo-day-clean.png", night: "tokyo-night-clean.png" }, screen:[36.55,41.6,25.4,19.8], broadcast:[6.7,18.5,10.35,27.6], objects:{phone:[13, 69.3, 13.2, 17.6],music:[32.4, 67, 3.1, 8.6],journal:[66.9,74.1,10.6,10.4],keyboard:[36.8,72.6,19.5,5.8],trackpad:[57.3,74.1,6.7,4.6],lamp:[8.5,39,19.5,27.5],mission:[69.8,54.8,6.15,12.1],notes:[79.7,56.5,10.5,13.4],vault:[19.7368,37.4070,4.6053,4.9947],bookshelf:[19,18,2.8,8]} },
  manhattan: { name:"New York", modes:{night:"Night",day:"Day"}, defaultTheme:"night", images:{night:"manhattan-night-clean.png",day:"manhattan-day-clean.png"},screen:[34.35,41.65,27.4,19.85],broadcast:[4.05,22.1,12.85,24.8],objects:{phone:[15.3, 67.4, 13.2, 17.6],music:[29.4, 66.8, 3.1, 8.6],journal:[69.6,73.6,8.9,9.4],keyboard:[33.3,72.5,24,6.3],trackpad:[58.7,73.3,6.5,4.8],lamp:[7.5,47,15.4,23.5],mission:[70.2,54.35,6.7,11.8],notes:[80.7,55.8,9.2,13.8],vault:[19.1986,37.1945,5.0239,6.5887],bookshelf:[19.2,23,5.5,2.5]} },
  dubai: {name:"Dubai",modes:{day:"Day",night:"Night"},defaultTheme:"day",images:{day:"dubai-day-clean.png",night:"dubai-night-clean.png"},screen:[33.75,40.4,27.2,21.8],broadcast:[4.7,21.1,12.45,21.3],objects:{phone:[15, 68.5, 13.2, 17.6],music:[28.9, 66.8, 3.1, 8.6],journal:[71,75.1,9.6,9.5],keyboard:[32.3,72.2,24.8,6],trackpad:[57.5,73,7.2,4.5],lamp:[8,45.5,13.6,25.5],mission:[71,55.35,6.9,11.7],notes:[80.5,53.2,11,17.5],vault:[20.3947,56.4293,4.3660,4.7821],bookshelf:[19.5,47,5,6]}}
};
...
const ROOM_ART = {
 ...
 manhattan:[[318,250,108,87],[1040,486,511,212],[318,341,94,82,318,135]],
...
const SPACING_LAYOUT = {
 ...
 manhattan:{day:{mission:[1101,513,111,107],notes:[1270,542,218,110]},night:{mission:[1066,512,108,107],notes:[1245,540,213,113]}},
 dubai:{day:{mission:[1086,520,108,108],notes:[1288,552,199,109]},night:{mission:[1066,520,108,108],notes:[1261,552,215,110]}}
};
...
function layoutRoomArtwork(){
 ...
 let desktop=plate.querySelector('.cape-desktop-clear');
 if(visibleArtwork.id==='cape'){
  if(!desktop){desktop=document.createElement('span');desktop.className='cape-desktop-clear';desktop.setAttribute('aria-hidden','true');plate.append(desktop);}
  const x=278,y=520,w=266,h=145,theme=visibleArtwork.file.includes('night')?'night':'day';
  Object.assign(desktop.style,{position:'fixed',pointerEvents:'none',left:r.left+x*r.width/1672+'px',top:r.top+y*r.height/941+'px',width:w*r.width/1672+'px',height:h*r.height/941+'px',backgroundImage:`url("${ASSETS}cape-${theme}-desktop-clear.png")`,backgroundSize:`${r.width}px ${r.height}px`,backgroundPosition:`${-x*r.width/1672}px ${-y*r.height/941}px`});
 }else desktop?.remove();
...
export const PANEL_LABELS = {research:"Saved research",performance:"Performance",tv:"Trading screen",laptop:"Command",mission:"Session Brief",calendar:"Calendar",clock:"Market sessions",window:"Market conditions",phone:"Winston",music:"Apple Music",journal:"Trade journal",notes:"Bull Report & notes",vault:"Vault checks",safe:"Approvals",lamp:"Risk & Bull Matrix",drawer:"Research lab",bookshelf:"Strategy library",mentor:"Mentor",account:"Account & access"};
const OBJECTS = {research:["research","Saved research","archive"], phone:["phone","Call Winston","phone-call"],music:["music","Apple Music","music"],journal:["journal","Trade journal","book-open"],keyboard:["laptop","Command","keyboard"],trackpad:["performance","Performance","chart-no-axes-combined"],lamp:["lamp","Risk & Bull Matrix","lamp"],mission:["mission","Session Brief","target"],notes:["notes","Bull Report & notes","file-text"],vault:["vault","Vault checks","vault"],pen:["safe","Approvals","pen-tool"],clock:["clock","Market sessions","clock"],bookshelf:["bookshelf","Strategy library","library"] };
...
export function roomHotspots() {
 ...
 return Object.entries(objects).map(([id,rect])=>{
  ...
  if(placed[id]){const [x,y,w,h]=placed[id];bounds={x:x/1672,y:y/941,w:w/1672,h:h/941};}
  return {id,panel:OBJECTS[id][0],label:OBJECTS[id][1],icon:OBJECTS[id][2],...bounds};
 });
}
export function objectMarkup(definition) {
  ...
  if(id==="phone") return `<span class="prop-art phone-art"><svg viewBox="0 0 1415 1061" aria-hidden="true"><image href="${ASSETS}phone-coastal.png" width="1415" height="1061"/></svg><span class="phone-display"><small>WINSTON</small><strong>Start call</strong><span>Brief · Research</span></span></span><span class="prop-caption">Winston</span>`;
  if(id==="music") return `<span class="prop-art music-art"><svg viewBox="58 46 910 1420" aria-hidden="true"><defs><clipPath id="player-silhouette"><path d="M160 129 Q162 49 235 50 L795 50 Q865 51 866 125 L884 1148 Q926 1160 939 1205 L963 1310 L963 1394 Q963 1447 900 1457 L119 1457 Q61 1447 61 1395 L61 1310 L84 1213 Q95 1171 139 1154 Z"/></clipPath></defs><image href="${ASSETS}pocket-player.png" width="1024" height="1536" clip-path="url(#player-silhouette)"/></svg><span class="music-display"><svg class="player-logo" viewBox="0 0 24 28" aria-hidden="true"><path fill="currentColor" d="M16.3 4.8c1.2-1.4 1.9-3.2 1.7-4.8-1.7.1-3.7 1.2-4.8 2.5-1 1.2-1.9 3-1.6 4.7 1.9.1 3.6-1 4.7-2.4ZM21.4 20.8c-.6 1.4-.9 2-1.7 3.3-1.2 1.8-2.8 4-4.8 4-1.7 0-2.1-1.1-4.4-1.1S7.7 28 6 28c-1.9 0-3.4-2-4.6-3.8C-2 19.2-.9 11.8 2.6 9.4c1.7-1.2 4-1.3 5.9-.5 1.4.6 2.2.6 3.5 0 1.7-.7 4.4-1.3 6.5.2.8.5 1.5 1.2 2 2-5.7 3.2-4.8 8.7.9 9.7Z"/></svg></span></span><span class="prop-caption">Music</span>`;
  ...
  if(id==="pen") return `<span class="desk-pen" aria-hidden="true"><svg viewBox="910 200 410 430"><defs><clipPath id="desk-pen-cut"><path d="M922 224 Q937 203 959 211 L1089 347 Q1110 348 1120 374 L1302 581 Q1317 605 1294 621 Q1278 631 1258 610 L1073 400 Q1054 394 1053 378 L925 255 Q913 242 922 224Z"/></clipPath></defs><image href="${ASSETS}journal.png" width="1536" height="1024" clip-path="url(#desk-pen-cut)"/></svg></span><small class="approval-count"></small><span class="prop-caption">Approvals</span>`;
